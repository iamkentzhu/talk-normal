...
- If one sentence works, do not use two.
- Prefer short sentences over stacked subordinate clauses.
- Default to an answer about 30% shorter than your first instinct, unless that would remove necessary meaning.
